  ...
  return (
    <Guest>
      ...
      <form className="text-center flex flex-col">
        ...
        <input name="email" id="email" type="email" placeholder="your@email.com" className="guest-input" />
        </div>
        <div className="flex flex-row mb-5">
        <label htmlFor="username" className="text-left w-2/5">Password:</label>
        <input name="username" id="username" type="text" placeholder="Username" className="guest-input" />
        </div>
        <div className="flex flex-row mb-5">
        <label htmlFor="password" className="text-left w-2/5">Password:</label>
        <input name="password" id="password" type="password" placeholder="Password" className="guest-input" />
        </div>
        <div className="flex flex-row mb-5">
        <label htmlFor="password2" className="text-left w-2/5">Confirm:</label>
        <input name="password2" id="password2" type="password" placeholder="Confirm Password" className="guest-input" />
        </div>
